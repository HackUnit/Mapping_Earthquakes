...
// Create the map object with center, zoom and default layer on Toronto
let map = L.map("mapid", {
    center: [44.0, -80.0], 
    zoom: 2,
    layers: [light]
...
// Accessing the Toronto airline routs GeoJSON URL.
let torontoData = "https://raw.githubusercontent.com/HackUnit/Mapping_Earthquakes/main/torontoRoutes.json";
...
// Code to add markers and popups with correct data on them.
